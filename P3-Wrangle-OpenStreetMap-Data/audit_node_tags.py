...
OSM_FILE = "D:/Dropbox/Data-Analysis/p3/OSM/manhattan.osm"  # Replace this with your osm file
...
# convert space to underscore (' ','_',key) for 'Rehearsal space'
# convert dot to colon ('.',':',key) for 'cityracks.housenum'

for key in node_problemchars_keys:
    if ' ' in key:
        key = convert_key(' ','_',key)
    elif '.' in key:
        key = convert_key('.',':',key)
